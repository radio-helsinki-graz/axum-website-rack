...
sub buss {
  ...
  table;
   ...
   Tr;
    ...
    th rowspan => 2, style => 'height: 40px; background: url("/images/table_head_40.png")',"2 Mono\nbusses";
    th colspan => 3, 'Master Pre/Post';
    th colspan => 2, 'Master';
    th rowspan => 2, style => 'height: 40px; background: url("/images/table_head_40.png")', 'Interlock';
    th rowspan => 2, style => 'height: 40px; background: url("/images/table_head_40.png")', 'Exclusive';
    th rowspan => 2, style => 'height: 40px; background: url("/images/table_head_40.png")',"Buss reset\nby module active";
