...
var EndYear = 100; //End Year offset. i.e. Current Year + 5
...
var SundayColor="#E0E0E0";//var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor="#E0E0E0";//Background color of Saturday.
var WeekDayColor="white";//Background color of weekdays.
var FontColor="blue";//color of font in Calendar day cell.
var TodayColor="#C0C0C0";//var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#000000";//var SelDateColor="#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor="#cc0033";//color of font of Year selector.
var MthSelColor="#cc0033";//color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor="#C0C0C0"; //color when mouse move over.
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' style='border-collapse: separate; border: 1px solid #000000' cellpadding=0 cellspacing=1 width='200px' valign='top'>\n";

	//Table for Month & Year Selector

	vCalHeader+="<tr>\n<td colspan='7'>\n<table width='200px' style='border-collapse: separate; border: 0px' cellpadding='0' cellspacing='0'>\n<tr>\n";
	//******************Month and Year selector in dropdown list************************

	if (Cal.Scroller=="DROPDOWN") {
		vCalHeader+="<td align='center' style='border: 0px'><select name=\"MonthSelector\" onChange=\"javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();\">\n";
		for (i=0;i<12;i++) {
			if (i==Cal.Month)
				SelectStr="Selected";
			else
		...
		vCalHeader+="<td align='center' style='border: 0px'><select name=\"YearSelector\" size=\"1\" onChange=\"javascript:Cal.SwitchYear(this.value);RenderCssCal();\">\n";
  ...
  //******************End Month and Year selector in arrow******************************
	...
	for (i=0;i<7;i++) {
		vCalHeader+="<td bgcolor="+WeekHeadColor+" width='"+CellWidth+"px' class='calTD'><font color='#a0a0a0'>"+WeekDayName[i].substr(0,WeekChar)+"</font></td>\n";
	}
	...
	if (Cal.ShowTime)
	{
		...
		vCalTime="\n<tr>\n<td colspan='7' align='center'><center>\n<table style='border: 0px border-collapse: separate' width='199px' cellpadding='0' cellspacing='2'>\n<tr>\n<td style='border: 0px' height='5px' width='"+HourCellWidth+"px'>&nbsp;</td>\n";
		...
		vCalTime+="<td style='border: 0px' align='center' width='22px'><input type='text' name='hour' maxlength=2 size=1 style=\"WIDTH:22px\" value="+showHour+" onChange=\"javascript:Cal.SetHour(this.value)\">";
		vCalTime+="</td><td style='border: 0px' align='center' style='font-size:150%; font-weight:bold;'>:</td><td style='border: 0px' align='center' width='22px'>";
		...
		if (Cal.ShowSeconds) {
			vCalTime+="</td><td style='border: 0px' align='center'>:</td><td style='border: 0px' align='center' width='22px'>";
		...
		vCalTime+="</td>\n<td style='border: 0px' align='right' valign='bottom' width='"+HourCellWidth+"px'>";
	}
    ...
    funcCalback+="if (datum== 'undefined') { var d = new Date(); datum = d.getDate() + '/' +(d.getMonth()+1) + '/' + d.getFullYear(); } window.calDatum=datum;\n";
    funcCalback+="location = '/config/setdatetime?date='+encodeURIComponent(datum)+'&time='+encodeURIComponent(Cal.getShowHour()+':'+Cal.Minutes+':'+Cal.Seconds);\n}\n";
...
function GenCell(pValue,pHighLight,pColor) { //Generate table cell with value
	...
	if (pColor!=null) {
    if (pColor == '#000000') {
      vColor="style='background-color: "+pColor+"; color: #ffffff'";
    } else {
      vColor="style='background-color: "+pColor+"'";
    }
  }
	else
		vColor=CalBgColor;
